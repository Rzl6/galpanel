...
后续修订的 GitHub Actions Run #61（提交 `4423a20`）已构建成功；下载的修正版 `galpanel-win-ble-baseline.uf2` 长度 `391680` bytes，SHA-256 为 `7CB1AB956A93405DD33F65D540FCF477D6694F710CADFFC6F1F13E00B6C8603D`。等待重新进入 UF2 Bootloader 后烧录。
