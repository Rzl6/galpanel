...
$requiredFiles = @(
    ...
    '稳定版本备份.md',
    'VERSION',
    'docs/images/galpanel-photo-placeholder.svg',
    'docs/images/galpanel-demo-placeholder.svg',
...
$checks = @(
    ...
    @{ File = 'config/boards/shields/galpanel/galpanel.keymap'; Pattern = '&mmv GP_MOVE_UP_RIGHT'; Name = 'upper-right side key moves pointer diagonally up-right' },
    @{ File = 'config/boards/shields/galpanel/galpanel.keymap'; Pattern = '&mmv GP_MOVE_DOWN_RIGHT'; Name = 'lower-right side key moves pointer diagonally down-right' },
    @{ File = 'config/boards/shields/galpanel/galpanel.keymap'; Pattern = '&mmv GP_MOVE_DOWN_LEFT'; Name = 'lower-left side key moves pointer diagonally down-left' },
    @{ File = 'config/boards/shields/galpanel/galpanel.keymap'; Pattern = '&mmv GP_MOVE_UP_LEFT'; Name = 'upper-left side key moves pointer diagonally up-left' },
